package com.hoocons.hoocons_android.CustomUI.xhs_common.adapter.emoticonadapter;

import android.content.Context;
import android.view.View;

import com.hoocons.hoocons_android.CustomUI.xhs_common.utils.ImageLoadUtils;
        ...
        viewHolder.rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnEmoticonClickListener != null) {
                    mOnEmoticonClickListener.onEmoticonClick(emoticonEntity, AppConstant.EMOTICON_CLICK_BIGIMAGE, isDelBtn);
                }
            }
        });
    }
