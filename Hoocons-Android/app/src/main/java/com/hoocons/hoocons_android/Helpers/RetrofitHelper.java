...
import com.hoocons.hoocons_android.DumbData.TestApiSwipeCard;
...
public class RetrofitHelper {
    ...
    private static TestApiSwipeCard apiService = null;
    ...
    public static TestApiSwipeCard api() {
        if (apiService == null) {
            init();
        }
        return apiService;
    ...
    private static void init() {
        ...
        retrofit = new retrofit2.Retrofit.Builder()
                .baseUrl(TestApiSwipeCard.HOST)
                .client(okHttpClient)
                .addConverterFactory(GsonConverterFactory.create(gson))
                .build();

        apiService = retrofit.create(TestApiSwipeCard.class);
    }
