...
public class FetchNearByPlacesJob extends Job implements Serializable {
    ...
    public FetchNearByPlacesJob(String latitude, String longitude, String placeHolder) {
    ...
    public void onRun() throws Throwable {
        ...
        services.getAroundPlaces(location, "50000",
                BaseApplication.getInstance().getGoogleServiceKey(), placeHolder)
