...
public class UnLikeEventJob extends Job implements Serializable {
    private int eventId;

    public UnLikeEventJob(String tag, int eventId) {
    ...
    public void onRun() throws Throwable {
        ...
        services.unlikeEvent(eventId).enqueue(new Callback<Void>() {
            @Override
