 ...
 */
public class ChatKeyboardWrapper extends XhsEmoticonsKeyBoard {
    public final int APPS_HEIGHT = 120;

    public ChatKeyboardWrapper(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    protected void inflateKeyboardBar(){
        mInflater.inflate(R.layout.chatroom_keyboard_wrapper, this);
    }
